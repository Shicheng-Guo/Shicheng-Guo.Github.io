...
```
* another tools called : RSeQC is also a powerful and much easier tool to infer RNA-seq strands. you can download required knowngene.hg19.bed12 from my github page: https://github.com/Shicheng-Guo/AnnotationDatabase/
```
pip install RSeQC
