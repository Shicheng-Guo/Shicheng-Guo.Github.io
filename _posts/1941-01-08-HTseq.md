...
```
* another tools called : RSeQC is also a powerful and much easier tool to infer RNA-seq strands
```
pip install RSeQC
infer_experiment.py -s 2000000 -r ../knowngene.hg19 -i UW040LPS_ATTCCT_L002Aligned.sortedByCoord.out.bam
```
