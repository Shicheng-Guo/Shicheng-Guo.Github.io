...
plink --bfile all_phase3 --allow-extra-chr --extract extract.txt --fst --within all_phase3.clst --out all_phase3 --threads 24

sort -r -k5,5n all_phase3.fst > all_phase3.sort.fst
