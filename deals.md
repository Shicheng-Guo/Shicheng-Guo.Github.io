...
<p class="lead">Recent business-development activity across pharma and biotech — mergers &amp; acquisitions, licensing, and partnerships — aggregated daily from public news and classified by deal type.</p>
...
<p class="trending-updated">
  Note: deals are auto-aggregated from public news (Google News &amp; biotech trade feeds) and classified by keyword matching into deal type. Always confirm details via the linked source. Updated daily by an automated job.
</p>
